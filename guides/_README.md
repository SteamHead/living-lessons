...
Human-facing how-tos for working on Living Lessons. `docs/` is the project's
record (decisions, changelogs); `guides/` is where you look when you're about
to *do* something.
...
Written for the solo-teacher-plus-AI workflow this project runs on. When a
guide goes stale, fix it in the same commit as whatever made it stale.
