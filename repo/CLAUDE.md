# CLAUDE.md — Live Lessons (draft)

Live Lessons is an interactive teaching, documentation, and reflection system
...
- github.com/SteamHead/steamhead-site-rebuild — the main site (Astro on
  Cloudflare Workers); Live Lessons inherits its stack and conventions.
