# Design Brief: Live Lessons — projected teaching interface for SteamHead

## What this is

Live Lessons replaces PowerPoint in an elementary school makerspace. A teacher projects it on a classroom wall; kids ages 6–12 watch from their seats; the teacher drives with a keyboard/clicker while talking, demonstrating, and improvising. It shows lessons, and it shows each class the skills they're building across a school year. Design the visual system and key screens.
